      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="p-6 bg-white border border-zinc-100 rounded-3xl shadow-premium group hover:border-emerald-200 transition-all cursor-pointer">
          <div class="h-12 w-12 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center mb-4 group-hover:bg-emerald-600 group-hover:text-white transition-all">
            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A3.323 3.323 0 0010.605 8.65a3.323 3.323 0 01-8.128-4.596 3.323 3.323 0 00-5.618 4.016A3.323 3.323 0 01.605 12.65a3.323 3.323 0 005.618 4.016 3.323 3.323 0 018.128 4.596 3.323 3.323 0 005.618-4.016A3.323 3.323 0 0122.618 12.65a3.323 3.323 0 00-5.618-4.016z" /></svg>
          </div>
          ...
          <div class="p-8 space-y-6">
            <div *ngFor="let i of [1,2,3]" class="flex items-start gap-4 p-4 rounded-2xl hover:bg-zinc-50 transition-all border border-transparent hover:border-zinc-100 group">
              <div class="h-10 w-10 rounded-xl bg-zinc-100 flex items-center justify-center shrink-0 group-hover:bg-white group-hover:shadow-sm">
                <svg class="h-5 w-5 text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 4v16m8-8H4" stroke-width="2" stroke-linecap="round" /></svg>
              </div>
              <div>
          ...
          <div class="relative z-10">
            ...
            <div class="space-y-3">
              <button class="w-full flex items-center justify-between p-4 bg-white/10 hover:bg-white/20 rounded-2xl transition-all border border-white/10 group/btn">
                ...
                <svg class="h-5 w-5 transition-transform group-hover/btn:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg>
              </button>
              <button class="w-full flex items-center justify-between p-4 bg-white/10 hover:bg-white/20 rounded-2xl transition-all border border-white/10 group/btn">
